...
'''
我们还是以一个简单的例子来讲解整个算法的流程。
比如，我们需要寻找函数y=x12+x22+x33+x44在[1,30]之间的最大值。
我们很容易就知道，当x1=x2=x3=x4=30时，该函数能取到最大值。
'''
class Gene:
    """
...
class GA:
    ...
    def evaluate(self, geneinfo):
        ...
        y = -((x1-1.7) ** 6 + (x2-1) ** 2 + (x3-2) ** 2+ (x4-2) ** 4)
    ...
    def selectBest(self, pop):
        ...
        """
        #按照fitness对字典进行排序,逆序排列，即从大到小，选取第一个，即适应度最大的返回
...
if __name__ == "__main__":
    CXPB, MUTPB, NGEN, popsize = 0.7, 0.2, 1000, 150  # popsize must be even number
    #生成相应类型的个体
