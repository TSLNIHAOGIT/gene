...
from geatpy_example.frame.schedule_same_times_v1.MyProblem_multi_process import MyProblem # 导入自定义问题接口
...
def each_brake(each_wait_list,L,W):
    ...
    myAlgorithm.MAXGEN = 70 # 13 # 最大进化代数

    ###和交叉变异的相关性比较大:0.9,0.2
    myAlgorithm.recOper = ea.Xovox(XOVR=0.9)  # 设置交叉算子 __init__(self, XOVR=0.7, Half=False)
    myAlgorithm.mutOper = ea.Mutinv(Pm=0.3)  # 设置变异算子
